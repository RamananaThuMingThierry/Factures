    ...
    <div class="row">
        <div class="mx-auto col-lg-6 col-md-6 mt-2 pt-4 pl-4 pr-4 elevation-1 bg-white">
            ...
            <div class="form-group">
                ...
                <input type="text" autocomplete="off"  value="<?php echo e(old('dernier_consommation') ?? ($laste_index_consommer ?? 0)); ?>" name="dernier_consommation" id="dernier_consommation" class="form-control rounded-0 <?php $__errorArgs = ['dernier_consommation'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- <div class="form-group">
                ...
                <input type="text" disabled autofocus autocomplete="off"  value="<?php echo e(old('tranche') ?? $tranche); ?>" name="tranche" id="tranche" class="form-control rounded-0 <?php $__errorArgs = ['tranche'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.dashboard',['titre' => 'Ajouter index du facture J.I.R.A.M.A'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2022\Février\Laravel\projet\Facture\resources\views/index/ajouter.blade.php ENDPATH**/ ?>