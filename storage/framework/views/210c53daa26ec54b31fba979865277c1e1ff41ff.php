<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="mx-auto col-lg-6 col-md-6 mt-2 pt-4 pl-4 pr-4 elevation-1 bg-white">
                            ...
                            <div class="form-group">
                                ...
                                <select name="numero_porte" class="form-control dernier_index_consommer rounded-0" id="numero_porte">
                                    <?php $__currentLoopData = $portes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <option value="<?php echo e($p->id); ?>" <?php echo e(( ($num_porte != null) ? ( $num_porte == $p->id ? 'selected' : '' ) : ( ( ($index->portes_id ?? null) == $p->id ? 'selected':'') ) )); ?>><?php echo e($p->numero_porte); ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="moisID" class="form-control rounded-0" id="moisID">
                                    ...
                                    <?php $__currentLoopData = $moisall; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <option value="<?php echo e($m->id); ?>" <?php echo e(( ($_mois != null ) ? ( $_mois == $m->id ? 'selected' : '' ) : ( ( ($index->mois_factures_id ?? null ) == $m->id ? 'selected':'') ) )); ?>><?php echo e($m->mois); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
            ...
            <hr>
            <form action="<?php echo e(route('index.chargement',['index' => $index->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="index" id="index" value="<?php echo e($index->id); ?>">
            <div class="form-group">
                <label for="numero_porte" class="control-label sr-only">Numéro Porte</label>
                <select name="numero_porte" class="form-control dernier_index_consommer rounded-0" id="numero_porte">
                    <?php $__currentLoopData = $portes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" autofocus autocomplete="off"  value="<?php echo e(old('dernier_consommation') ?? (($laste_index_consommer != null) ? $laste_index_consommer : ($index->dernier_consommation ?? 0) )); ?>" name="dernier_consommation" id="dernier_consommation" class="form-control rounded-0 <?php $__errorArgs = ['dernier_consommation'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" autofocus autocomplete="off"  value="<?php echo e(old('nouvel_consommation') ?? (($first_index_consommer != null ) ? $first_index_consommer : ($index->nouvel_consommation ?? 0) )); ?>" name="nouvel_consommation" id="nouvel_consommation" class="form-control rounded-0 <?php $__errorArgs = ['nouvel_consommation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.dashboard',['titre' => 'Modifier une index du facture J.I.R.A.M.A'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2022\Février\Laravel\projet\Facture\resources\views/index/edit.blade.php ENDPATH**/ ?>