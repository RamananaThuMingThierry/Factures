<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="mx-auto col-lg-6 col-md-6 mt-2 pt-4 pl-4 pr-4 elevation-1 bg-white">
            ...
            <hr>
            <form action="<?php echo e(route('index.chargement')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard',['titre' => 'Modifier une index du facture J.I.R.A.M.A'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\2022\Février\Laravel\projet\Facture\resources\views/index/edit.blade.php ENDPATH**/ ?>