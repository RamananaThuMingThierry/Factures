<hr>
        ...
        <div class="form-group">
            ...
            <input type="text" autofocus autocomplete="off"  value="<?php echo e(old('ancien_index') ?? $laste_mois); ?>" name="ancien_index" id="ancien_index" class="form-control rounded-0 <?php $__errorArgs = ['ancien_index'];
...
<?php /**PATH D:\2022\Février\Laravel\projet\Facture\resources\views/mois/form.blade.php ENDPATH**/ ?>